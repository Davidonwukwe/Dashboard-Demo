        ...
        <div className={'d-flex justify-content-between flex-wrap px-md-5 px-3 pt-3'}>
            ...
            <div className={'legend d-flex justify-content-between text-nowrap'}>
                <div className={'ms-sm-0 mx-lg-3'}>
                    <p className={'legendName pb-0'}><svg xmlns="http://www.w3.org/2000/svg" width="8" height="9" viewBox="0 0 8 9" fill="none">
                ...
                <div className={'mx-3'}>
                    <p className={'legendName pb-0'}><svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 9 9" fill="none">
